...
#
"""
Emmet/Ace get VIF channel info example
"""
...
def _main():
    ...
    parser.add_argument("--vif", default="VIF_STA",
                        help="VIF to query (VIF_STA or VIF_AP)")
    ...
    rsp = dutif.exec("wlan/get_vif_channel_info", vif=args.vif)

    print(f"op_class: {rsp.op_class}")
    print(f"s1g_chan_num: {rsp.s1g_chan_num}")
    print(f"pri_bw_mhz: {rsp.pri_bw_mhz}")
    print(f"pri_1mhz_chan_idx: {rsp.pri_1mhz_chan_idx or 0}")
