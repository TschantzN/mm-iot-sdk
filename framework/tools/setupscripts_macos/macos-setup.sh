...
#
# Tested on macOS Sequoia 15.5 arm64
#
...
then
    ...
    EXPERIMENTAL - MacOS support is in alpha and will likely have issues. If you
    identify any issues, please raise them on https://community.morsemicro.com
    ...
    read -p $'Press \033[1mCTRL-C\033[0m to abort or \033[1mENTER\033[0m to continue...'
else
